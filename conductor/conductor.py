...
def main():
    ...
    if not (os.path.isfile('C:\\results\\tocs.csv') and os.path.isfile('C:\\results\\flower.csv')):
        with open('C:\\results\\tocs.csv', 'w', newline='') as tocs_csv, open('C:\\results\\flower.csv', 'w', newline='') as flower_csv:
    ...
    for p in parameters:
        with open('C:\\results\\tocs.csv', 'a', newline='') as tocs_csv, open('C:\\results\\flower.csv', 'a', newline='') as flower_csv:
            tocs_writer = csv.DictWriter(tocs_csv, fieldnames=fieldnames)
            flower_writer = csv.DictWriter(flower_csv, fieldnames=fieldnames)
