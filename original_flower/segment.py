...
import original_flower.point
from original_flower.sensor import Packet
from original_flower import params

class Segment(original_flower.point.WorldPositionMixin):
    count = 0

    def __init__(self, x=0.0, y=0.0):
        original_flower.point.WorldPositionMixin.__init__(self, x, y)
